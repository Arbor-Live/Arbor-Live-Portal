  ...
  return (
    <EmailLayout preview={`Payment payee info needed for ${eventTitle}`} heading="Payment Payee Required">
      ...
      <BodyCopy>
        ...
        processing. Before we can send a payment confirmation email, we need a designated payee on file
      ...
      <DataCard title="What we need">
        ...
        <DetailRow label="Payee email" value="Used for payment confirmation replies" />
      ...
      <BodyCopy>
        Once your payee information is saved, our team can send the payment confirmation email and move
        your payout forward.
      </BodyCopy>
