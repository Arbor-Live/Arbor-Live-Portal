...
export function BandPaymentPayeeRequiredEmail({
  ...
  return (
    <EmailLayout preview={`Payment payee info needed for ${eventTitle}`} heading="Payment Payee Required">
      ...
      <BodyCopy>
        {bandName} performed at an Arbor Live event and we&apos;re ready to begin payment
      ...
      <DataCard title="What we need">
        <DetailRow label="Designated payee" value="One member who receives and distributes payment" />
      ...
      <BodyCopy>
        ...
        Stanford VSO (not just Arbor Live), Stanford will issue them a Form 1099. Artists may want
        to rotate the designated payee among members to stay under that threshold.
      </BodyCopy>
      <MutedCopy>You are receiving this because you have a pending Arbor Live payout.</MutedCopy>
    </EmailLayout>
  );
}
