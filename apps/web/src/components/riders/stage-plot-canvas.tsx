      ...
      >
        ...
        {content.items.map((item) => {
          ...
          return (
            <div
              key={`label-${item.id}`}
              className="pointer-events-none absolute truncate text-center text-[10px] leading-tight font-medium text-status-slate-900"
        ...
        <span
          className="pointer-events-none absolute text-[9px] tracking-widest text-status-slate-500"
          style={{ left: stage.left + 6, top: stage.top + 5 }}
        >
          STAGE RIGHT
        </span>
        <span
          className="pointer-events-none absolute text-right text-[9px] tracking-widest text-status-slate-500"
          style={{ left: stage.left, top: stage.top + 5, width: stage.width - 6 }}
        >
          STAGE LEFT
        </span>
        <span
          className="pointer-events-none absolute text-center text-[9px] tracking-widest text-status-slate-500"
          style={{ left: stage.left, top: stage.top + 5, width: stage.width }}
        >
          UPSTAGE · {content.stage.widthFt} × {content.stage.depthFt} FT
        </span>
        <span
          className="pointer-events-none absolute text-center text-[10px] font-semibold tracking-[0.2em] text-status-slate-900"
