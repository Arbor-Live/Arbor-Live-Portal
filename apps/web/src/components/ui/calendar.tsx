    ...
    <DayPicker
      ...
      formatters={{
        formatMonthDropdown: (date) =>
          date.toLocaleString(locale?.code, { month: "short", timeZone }),
        ...formatters,
      }}
      classNames={{
        ...classNames,
