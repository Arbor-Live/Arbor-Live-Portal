...
export function StoredAssetImage({
  storedValue,
  alt = "",
  className,
  fallbackClassName,
...
export function StoredAssetLink({
  storedValue,
  children,
  className,
}: {
  ...
  const href = useResolvedAssetUrl(storedValue);
...
/** @deprecated Use StoredAssetImage */
export const InventoryAssetImage = StoredAssetImage;
