...
/** Arbor-forward edge tints (linear-ish). Green is brand primary. */
const EDGE_RED = { r: 0.35, g: 0.55, b: 0.12 };
const EDGE_GREEN = { r: 0.02, g: 0.52, b: 0.14 };
const EDGE_BLUE = { r: 0.05, g: 0.38, b: 0.28 };
const LUMA_R = 0.2126;
const LUMA_G = 0.7152;
const LUMA_B = 0.0722;
