...
type TriangleLedBackgroundProps = {
  className?: string;
};

/** Full-bleed WebGPU triangle LED field. Falls back to empty when unavailable. */
export function TriangleLedBackground({ className }: TriangleLedBackgroundProps) {
  ...
  useEffect(() => {
    ...
    void renderer.ready
      ...
      .catch(() => {
        // CSS / video fallback from the hero.
      });
