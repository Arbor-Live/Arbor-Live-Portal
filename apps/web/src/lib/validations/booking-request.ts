...
const BASE_STEPS: BookingRequestStepConfig[] = [
  ...
  },
  {
    ...
    subheader:
      "Pick your event date on the calendar — dots show how busy we already are (green is best). Add times on the right, and use “Add another event” for multiple performances or different days. Events requested with less than seven days' notice may have limited availability and overtime rates.",
